...
const LamdielCards: Card[] = [
  {
    ...
    name: 'Ambush',
    frontImageUrl: '/hero-sets/lamdiel/deck/Ambush.svg',
  ...
  },
  {
    ...
    frontImageUrl: '/hero-sets/lamdiel/deck/CORRUPT the future.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
  {
  ...
  },
  {
    ...
    name: 'Madness',
    frontImageUrl: '/hero-sets/lamdiel/deck/Madness.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Open your mind',
    frontImageUrl: '/hero-sets/lamdiel/deck/Open your mind.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    frontImageUrl: '/hero-sets/lamdiel/deck/TRIPLE LAYER OF FEAR.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Vampire kiss',
    frontImageUrl: '/hero-sets/lamdiel/deck/VAMPIRE KISS.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    frontImageUrl: '/hero-sets/lamdiel/deck/We are the same.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Who am I?',
    frontImageUrl: '/hero-sets/lamdiel/deck/Who AM I?.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    frontImageUrl: '/hero-sets/lamdiel/deck/You are not existed.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Prediction',
    frontImageUrl: '/hero-sets/lamdiel/deck/prediction.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 1,
  },
  {
    ...
    frontImageUrl: '/hero-sets/lamdiel/deck/you imagined it.svg',
    backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    qty: 2,
  },
];
  ...
  ruleCards: [
    {
      ...
      frontImageUrl: '/hero-sets/lamdiel/characters/Lamdiel.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('1134ef7f-fb81-4264-8c15-adba8f84220f'),
      frontImageUrl: '/hero-sets/lamdiel/rules/Rule card 1.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('6418e51b-3869-496c-91f6-c0fc62b98adb'),
      frontImageUrl: '/hero-sets/lamdiel/rules/Rule card 2.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('1756fe22-ffe2-46dc-9564-6b6c30e40c67'),
      frontImageUrl: '/hero-sets/lamdiel/rules/Rule card 3.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('22c0429a-2072-48bd-bafc-14a6f58e062b'),
      frontImageUrl: '/hero-sets/lamdiel/rules/Rule card 4.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('25255ece-8e22-4c32-9721-4c41031756bc'),
      frontImageUrl: '/hero-sets/lamdiel/rules/Rule card 5.svg',
      backImageUrl: '/hero-sets/lamdiel/deck-front-image.png',
    },
  ],
  cards: LamdielCards,
...
const DekuCards: Card[] = [
  {
    ...
    frontImageUrl: '/hero-sets/deku/deck/Controlled Smash.svg',
  ...
  },
  {
    ...
    frontImageUrl: '/hero-sets/deku/deck/Delaware Detroit Smash.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Delaware Smash',
    frontImageUrl: '/hero-sets/deku/deck/Delaware Smash.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Detroit Smash',
    frontImageUrl: '/hero-sets/deku/deck/Detroit Smash.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Feint',
    frontImageUrl: '/hero-sets/deku/deck/Feint.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    name: 'Heroic Grit',
    frontImageUrl: '/hero-sets/deku/deck/Heroic Grit.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    name: 'Heroic Spirit',
    frontImageUrl: '/hero-sets/deku/deck/Heroic Spirit.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    frontImageUrl: '/hero-sets/deku/deck/Heroic Struggle.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 3,
  },
  {
    ...
    name: 'Jet Set Run',
    frontImageUrl: '/hero-sets/deku/deck/Jet Set Run.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    frontImageUrl: '/hero-sets/deku/deck/Momentous Shift.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Plus Ultra',
    frontImageUrl: '/hero-sets/deku/deck/Plus Ultra.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Shoot Style',
    frontImageUrl: '/hero-sets/deku/deck/Shoot Style.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
  {
    ...
    name: 'Skirmish',
    frontImageUrl: '/hero-sets/deku/deck/Skirmish.svg',
    backImageUrl: '/hero-sets/deku/deck-front-image.png',
    qty: 2,
  },
];
  ...
  ruleCards: [
    {
      ...
      frontImageUrl: '/hero-sets/deku/characters/Deku.svg',
      backImageUrl: '/hero-sets/deku/deck-front-image.png',
    },
    {
      id: RuleCardId.ofString('d2dd2f67-5007-4c8f-b11a-84dfd05835b8'),
      frontImageUrl: '/hero-sets/deku/rules/Rule card 1.svg',
      backImageUrl: '/hero-sets/deku/deck-front-image.png',
    },
  ],
  cards: DekuCards,
