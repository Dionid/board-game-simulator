...
export var essencePoolsStore = syncedStore({ pools: {} });
export var essenceEventsStore = syncedStore({
  events: {},
});
...
export var initStore = function (roomId) {
  // Get the Yjs document and sync automatically using y-webrtc
  var doc = getYjsValue(essencePoolsStore);
  if (!doc) {
