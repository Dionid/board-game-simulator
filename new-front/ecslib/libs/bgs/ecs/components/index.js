...
// # PLAYERS
export var PlayerComponent = ComponentFactory('PlayerComponent');
/**
  @desc Give us a way to understand what our player owns (like cards)
**/
export var OwnerComponent = ComponentFactory('OwnerComponent');
// # Input
export var FingerComponent = ComponentFactory('FingerComponent');
// # CAMERA
export var CameraComponent = ComponentFactory('CameraComponent');
export var PanModeComponent = ComponentFactory('PanModeComponent');
// # GEOMETRY
export var PositionComponent = ComponentFactory('PositionComponent');
export var SizeComponent = ComponentFactory('SizeComponent');
export var ScaleComponent = ComponentFactory('ScaleComponent');
// . GAME OBJECT
export var GameObjectComponent = ComponentFactory('GameObject');
export var DepthComponent = ComponentFactory('DepthComponent');
export var ImageComponent = ComponentFactory('ImageComponent');
export var MultipleImagesComponent = ComponentFactory('MultipleImagesComponent');
export var GroupComponent = ComponentFactory('GroupComponent');
...
// >;
// # ACTIONS ON GO
export var SelectableComponent = ComponentFactory('SelectableComponent');
export var IsSelectedComponent = ComponentFactory('IsSelectedComponent');
export var LockableComponent = ComponentFactory('LockableComponent');
export var IsLockedComponent = ComponentFactory('IsLockedComponent');
export var DraggableComponent = ComponentFactory('DraggableComponent');
export var IsDraggingComponent = ComponentFactory('IsDraggingComponent');
export var DeletableComponent = ComponentFactory('DeletableComponent');
...
//   }
// >("CardComponent");
export var FlippableComponent = ComponentFactory('FlippableComponent');
export var CounterComponent = ComponentFactory('CounterComponent');
// // .. SPAWN EVENTS
