...
// # PLAYERS
export const PlayerComponent = ComponentFactory('PlayerComponent');
/**
  @desc Give us a way to understand what our player owns (like cards)
**/
export const OwnerComponent = ComponentFactory('OwnerComponent');
// # Input
export const FingerComponent = ComponentFactory('FingerComponent');
// # CAMERA
export const CameraComponent = ComponentFactory('CameraComponent');
export const PanModeComponent = ComponentFactory('PanModeComponent');
// # GEOMETRY
export const PositionComponent = ComponentFactory('PositionComponent');
export const SizeComponent = ComponentFactory('SizeComponent');
export const ScaleComponent = ComponentFactory('ScaleComponent');
// . GAME OBJECT
export const GameObjectComponent = ComponentFactory('GameObject');
export const DepthComponent = ComponentFactory('DepthComponent');
export const ImageComponent = ComponentFactory('ImageComponent');
export const MultipleImagesComponent = ComponentFactory('MultipleImagesComponent');
export const GroupComponent = ComponentFactory('GroupComponent');
...
// >;
// # ACTIONS ON GO
export const SelectableComponent = ComponentFactory('SelectableComponent');
export const IsSelectedComponent = ComponentFactory('IsSelectedComponent');
export const LockableComponent = ComponentFactory('LockableComponent');
export const IsLockedComponent = ComponentFactory('IsLockedComponent');
export const DraggableComponent = ComponentFactory('DraggableComponent');
export const IsDraggingComponent = ComponentFactory('IsDraggingComponent');
export const DeletableComponent = ComponentFactory('DeletableComponent');
...
//   }
// >("CardComponent");
export const FlippableComponent = ComponentFactory('FlippableComponent');
export const CounterComponent = ComponentFactory('CounterComponent');
// // .. SPAWN EVENTS
