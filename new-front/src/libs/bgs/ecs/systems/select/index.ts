...
export const SelectSystem = (): System<{
  ...
  return {
    run: async ({ essence }) => {
      const selectableEntities = Essence.getEntitiesByComponents(essence, [
        SelectableComponentName,
        PositionComponentName,
        SizeComponentName,
      ]);
      ...
      const playerMouseEntities = Essence.getEntitiesByComponents(essence, [
        PlayerComponentName,
        OwnerComponentName,
        HandComponentName,
      ]);
      const isSelectedEntities = Essence.getEntitiesByComponents(essence, [IsSelectedComponentName]);
