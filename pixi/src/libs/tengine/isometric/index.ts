...
export function tileCartesianPosition(tp: TablePosition, tileSize: Size): Vector2 {
  return {
...
export function cartesianTileRowCol(position: Vector2, tileSize: Size): TablePosition {
  return {
